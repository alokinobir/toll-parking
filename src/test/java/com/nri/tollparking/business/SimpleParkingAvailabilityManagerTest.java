...
public class SimpleParkingAvailabilityManagerTest {
    ...
    public void testConstructor() {
        ...
        try {
            new SimpleParkingAvailabilityManager(null);
    ...
    public void testBookAndFreeSlots() {
        ...
        SimpleParkingAvailabilityManager availabilityManager = new SimpleParkingAvailabilityManager(mockParking);
